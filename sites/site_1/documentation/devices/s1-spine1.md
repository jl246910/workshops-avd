...
```eos
!
username arista privilege 15 role network-admin secret sha512 $6$1GpnbqMIOjGZP06G$imfAn1GB1WAg1xdW2M.CUAEA.BpIQEgaUKSSIQsp4iCaJLSz/rO5D4QphWAU.WvckF717RxqDI/Mn2s3jL0P0/
```
